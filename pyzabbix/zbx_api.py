...
from hostgroup import HostgroupAPI
...
class ZabbixAPI(object):
    def __init__(self,
        ...
        self.config = ConfigurationAPI(self)
        self.hostgroup = HostgroupAPI(self)
        self.mediatype = MediatypeAPI(self)
        self.template = TemplateAPI(self)
        self.user = UserAPI(self)
        self.usergroup = UsergroupAPI(self)
        self.auth = self.user.login(user, password)
